      ...
      if (frequency === "6回/週") {
        if (volume === "多いのがいい！") {
          createMenu("6回/週のハードメニュー", [
            { day: "月曜日", exercises: ["ディップス 10回×5セット", "腕立て伏せ 20回×5セット"] },
            { day: "火曜日", exercises: ["懸垂 10回×10セット"] },
            { day: "水曜日", exercises: ["ブルガリアンスクワット 10回×5セット", "スクワット 20回×5セット"] },
            { day: "木曜日", exercises: ["ディップス 10回×5セット", "腕立て伏せ 20回×5セット"] },
            { day: "金曜日", exercises: ["懸垂 10回×10セット"] },
            { day: "土曜日", exercises: ["クランチ 20回×5セット", "レッグレイズ 20回×5セット"] },
            { day: "日曜日", exercises: ["休み"] }
          ]);
        } else if (volume === "普通がいいかな〜") {
          createMenu("6回/週の標準メニュー", [
            { day: "月曜日", exercises: ["ディップス 10回×3セット", "腕立て伏せ 20回×3セット"] },
            { day: "火曜日", exercises: ["懸垂 10回×5セット"] },
            { day: "水曜日", exercises: ["ブルガリアンスクワット 10回×3セット", "スクワット 20回×3セット"] },
            { day: "木曜日", exercises: ["ディップス 10回×3セット", "腕立て伏せ 20回×3セット"] },
            { day: "金曜日", exercises: ["懸垂 10回×5セット"] },
            { day: "土曜日", exercises: ["クランチ 20回×3セット", "レッグレイズ 20回×3セット"] },
            { day: "日曜日", exercises: ["休み"] }
          ]);
        } else {
          createMenu("6回/週の軽めメニュー", [
            { day: "月曜日", exercises: ["ディップス 10回×2セット", "腕立て伏せ 20回×2セット"] },
            { day: "火曜日", exercises: ["懸垂 10回×3セット"] },
            { day: "水曜日", exercises: ["ブルガリアンスクワット 10回×2セット", "スクワット 20回×2セット"] },
            { day: "木曜日", exercises: ["ディップス 10回×2セット", "腕立て伏せ 20回×2セット"] },
            { day: "金曜日", exercises: ["懸垂 10回×3セット"] },
        ...
        if (volume === "多いのがいい！") {
          createMenu("4回/週のハードメニュー", [
            ...
            { day: "火曜日", exercises: ["懸垂 10回×10セット"] },
            { day: "水曜日", exercises: ["ブルガリアンスクワット 10回×5セット", "スクワット 20回×5セット"] },
            { day: "金曜日", exercises: ["懸垂 10回×5セット", "ディップス 10回×5セット"] },
          ...
          createMenu("4回/週の標準メニュー", [
            ...
            { day: "火曜日", exercises: ["懸垂 10回×5セット"] },
            { day: "水曜日", exercises: ["ブルガリアンスクワット 10回×3セット", "スクワット 20回×3セット"] },
            { day: "金曜日", exercises: ["懸垂 10回×3セット", "ディップス 10回×3セット"] },
            { day: "水土日", exercises: ["休み"] }
          ]);
        } else {
          createMenu("4回/週の軽めメニュー", [
            { day: "月曜日", exercises: ["ディップス 10回×2セット", "腕立て伏せ 20回×2セット"] },
            { day: "火曜日", exercises: ["懸垂 10回×2セット"] },
            { day: "水曜日", exercises: ["ブルガリアンスクワット 10回×2セット", "スクワット 20回×2セット"] },
            { day: "金曜日", exercises: ["懸垂 10回×2セット", "ディップス 10回×2セット"] },
            { day: "水土日", exercises: ["休み"] }
          ]);
        }
        ...
        if (volume === "多いのがいい！") {
          createMenu("3回/週のハードメニュー", [
            { day: "月曜日", exercises: ["懸垂 10回×5セット", "ディップス 10回×5セット"] },
            { day: "水曜日", exercises: ["ブルガリアンスクワット 10回×5セット", "スクワット 20回×5セット"] },
            { day: "金曜日", exercises: ["懸垂 10回×5セット", "ディップス 10回×5セット"] },
          ...
          createMenu("3回/週の標準メニュー", [
            { day: "月曜日", exercises: ["懸垂 10回×3セット", "ディップス 10回×3セット"] },
            { day: "水曜日", exercises: ["ブルガリアンスクワット 10回×3セット", "スクワット 20回×3セット"] },
            { day: "金曜日", exercises: ["懸垂 10回×3セット", "ディップス 10回×3セット"] },
            { day: "火木土日", exercises: ["休み"] }
          ]);
          ...
          createMenu("3回/週の軽めメニュー", [
            { day: "月曜日", exercises: ["懸垂 10回×2セット", "ディップス 10回×2セット"] },
            { day: "水曜日", exercises: ["ブルガリアンスクワット 10回×2セット", "スクワット 20回×2セット"] },
            { day: "金曜日", exercises: ["懸垂 10回×2セット", "ディップス 10回×2セット"] },
            { day: "火木土日", exercises: ["休み"] }
          ]);
